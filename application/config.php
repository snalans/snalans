...
return [
    ...
    // 获取IP的变量
    'http_agent_ip'          => 'REMOTE_ADDR',//HTTP_CF_CONNECTING_IP
    // +----------------------------------------------------------------------
    // | 模块设置
    // +----------------------------------------------------------------------
    // 默认模块名
    ...
    'log'                    => [
        ...
        'level' => [],
        // error和sql日志单独记录
        'apart_level' => ['error','sql','info','sms','reward'],
    ],
    // +----------------------------------------------------------------------
    ...
    'fastadmin'              => [
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,chat.tes,h5.snalans.com,egg.snalans.com',
        //版本号
